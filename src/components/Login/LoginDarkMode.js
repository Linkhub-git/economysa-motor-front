...
function LoginDarkMode() {
  ...
  const encodeData = btoa(
    process.env.REACT_APP_USER_TOKEN + ":" + process.env.REACT_APP_PASS_TOKEN
  );
      ...
      {darkMode === true ? (
        <section className="loginContainerAll_dark">
          <i
            ...
            className="far fa-circle btn-darkModeLogin_dark"
          ></i>
          <div>
            <main>
              <div className="loginContainer_dark">
                <div className="loginContent">
                  ...
                  <h1 className="titleLogin_dark">
                    <span>Ingresa a</span> <span>Economysa</span>
                  </h1>
                  <p className="parrafoLogin_dark">
                    Bienvenido. Ingrese sus credenciales.
                  </p>
                  <Form className="formLogin" onSubmit={formulario}>
                    <Form.Group
                      className="mb-3 inputRegister_dark"
                      controlId="formBasicEmail"
                    >
                      <Form.Label>Correo electrónico</Form.Label>
                      <Form.Control
                        onChange={(e) => setEmail(e.target.value)}
                        className="inputRegisterInput_dark"
                        type="email"
                    ...
                    <button
                      className="btn-datosFormRegister_dark"
                      type="submit"
                    >
                      Ingresar
                    </button>
