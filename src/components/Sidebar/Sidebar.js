...
function Sidebar(props) {
  ...
  useEffect(()=>{
    ...
    console.log(sideBar.current.contains);
  ...
  console.log(sideBarDesktop.current);
 /*  useEffect(()=>{
  ...
  return(
    <aside ref={sideBarDesktop} className={props.hideSidebarDesk === true ? "" : "sideBarHideDesktop"}>
