...
function Sidebar(props) {
  ...
  return (
    <aside
      onMouseOver={ChangeStyleSidebar}
      onMouseOut={ChangeStyleSidebarOut}
      ref={sideBarDesktop}
      className={
        props.hideSidebarDesk === true
          ? "testSidebar"
          : "testSidebar sideBarHideDesktop"
      }
    >
      <div
        className={
          props.showAlittleSidebar === false
            ? "testSidebar"
            : "testSidebar showALittleSidebar"
        }
      >
        <div
          ref={sideBar}
          className={
            props.btnShowSideBar === false
              ? "sidebarContainer"
              : "sidebarContainer activeShow"
          }
        >
          <div
            ref={logoSidebar}
            className={
              props.showAlittleSidebar === false
                ? "iconTitleSideBar"
                : "iconTitleSideBar showALittleSidebarLogo"
            }
          >
            <Link
              className={
                props.hideSidebarDesk === true
                  ? "linkHeaderSidebar"
                  : "linkHeaderSidebar sideBarHideDesktopMoveLogo"
              }
              to="/"
            >
          ...
          <div className="linksContainer">
            ...
            <Accordion defaultActiveKey={props.numberActiveSidebar} alwaysOpen>
              <Accordion.Item
                ...
                className={
                  props.showAlittleSidebar === false
                    ...
                    : "contentContainerLink hideArrowSidebar"
                }
              >
                <Link className="linkSidebarHome linkDashboardSidebar" to="/">
                  <Accordion.Header
                    className={
                      props.hideSidebarDesk === true
                        ? "titleLink"
                        : "titleLink sideBarHideDesktopIcons"
                    }
                  >
                    Dashoard <i className="fas fa-home"></i>
                  </Accordion.Header>
                </Link>
              </Accordion.Item>
              ...
              >
                ...
                >
                  Seguridad <i className="fas fa-lock lockLink"></i>
                </Accordion.Header>
                <Accordion.Body className="contentInsideLink">
                  <div className="individualLinkContainer">
                    <Link to="/Seguridad" className="linkBar">
                      Usuario <i className="fas fa-users"></i>
                    </Link>
                  </div>
                </Accordion.Body>
              </Accordion.Item>
              ...
              >
                ...
                >
                  Configuración <i className="fas fa-paperclip"></i>
                </Accordion.Header>
                <Accordion.Body className="contentInsideLink">
                  <div className="individualLinkContainer">
                    <Link to="/motor/1" className="linkBar">
                      Categorías<i className="fas fa-directions"></i>
                    </Link>
                  </div>
                  <div className="individualLinkContainer">
                    <Link to="/motor/2" className="linkBar">
                      Marcas <i className="fas fa-folder"></i>
                    </Link>
                  </div>
                  <div className="individualLinkContainer">
                    <Link to="/" className="linkBar">
                      Unidades <i className="fas fa-th-large"></i>
                    </Link>
                  </div>
                </Accordion.Body>
              </Accordion.Item>
              ...
              >
                ...
                >
                  Motor <i className="fas fa-globe-americas"></i>
                </Accordion.Header>
                <Accordion.Body className="contentInsideLink">
                  <div className="individualLinkContainer">
                    <Link to="/motor/1" className="linkBar">
                      Clientes<i className="fas fa-list-ul"></i>
                    </Link>
                  </div>
                  <div className="individualLinkContainer">
                    <Link to="/motor/2" className="linkBar">
                      Direcciones Entrega <i className="fas fa-folder"></i>
                    </Link>
                  </div>
                  <div className="individualLinkContainer">
                    <Link to="/" className="linkBar">
                      Productos <i className="fas fa-bookmark"></i>
                    </Link>
                  </div>
                  <div className="individualLinkContainer">
                    <Link to="/" className="linkBar">
                      Mecánicas <i className="fas fa-bookmark"></i>
                    </Link>
                  </div>
                  <div className="individualLinkContainer">
                    <Link to="/" className="linkBar">
                      Proveedores <i className="fas fa-bookmark"></i>
                    </Link>
                  </div>
                  <div className="individualLinkContainer">
                    <Link to="/" className="linkBar">
                      Vendedores <i className="fas fa-bookmark"></i>
                    </Link>
                  </div>
                </Accordion.Body>
              </Accordion.Item>
